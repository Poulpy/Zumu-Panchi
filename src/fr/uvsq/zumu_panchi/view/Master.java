...
public class Master extends JFrame {
    ...
    /**
     * Specify the look and feel to use by defining the LOOKANDFEEL constant Valid
     * values are: null (use the default), "Metal", "System", "Motif", and "GTK"
     */
    final static String LOOKANDFEEL = "System";

    /**
     * If you choose the Metal L&F, you can also choose a theme. Specify the theme
     * to use by defining the THEME constant Valid values are: "DefaultMetal",
     * "Ocean", and "Test"
     */
    ...
    public void initGUI() {
        ...
        setIconImage(Toolkit.getDefaultToolkit()
                .getImage(Master.class.getClassLoader().getResource("cochon.png")));
        ...
        BookshopController bookshopController = new BookshopController(bookshop, cart,
                salesJournal);

        // the tab to pass an order
        JComponent panel1 = new OrderPane(bookshopController);
        tabbedPane.addTab("Order", panel1);

        // the tab containing the sales
